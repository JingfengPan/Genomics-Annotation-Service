...
class Config(object):
    ...
    # Stripe
    STRIPE_PUBLIC_KEY = "pk_test_51Sa7VAPVGcSErGrqEYNnTLXh3nUCULrAYb7SxGj269xVXQvxQWQaz504t5egBaXDu1GM1NuCVTCV3KrxuN1tRzf2009feZTIY1"
    STRIPE_SECRET_KEY = "sk_test_51Sa7VAPVGcSErGrqSimghEHOSE1ZCiREWuJSNIhM9aHFcMDMKUm4deBhJANBx5vLjNwkjNO6QdXUZIXDJ4zqQraT008rde0RyV"
    STRIPE_PRICE_ID = "price_1Sa7yaPVGcSErGrqFyBmgnd2"
    ...
    AWS_SNS_JOB_REQUEST_SUBJECT = "GAS annotation request"
    
    AWS_SNS_THAW_TOPIC = (
        f"arn:aws:sns:us-east-1:127134666975:{iam_username}_a17_thaw_topic"
    )
    
    AWS_SNS_GLACIER_RESTORE_TOPIC = (
        f"arn:aws:sns:us-east-1:127134666975:{iam_username}_a17_glacier_restore"
    )
    ...
    AWS_DYNAMODB_USER_ID_INDEX = "user_id_index"
